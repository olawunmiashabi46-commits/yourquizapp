...
const selectedSubject = sessionStorage.getItem("adminSelectedSubject");

if (!selectedSubject) {
    // No subject was chosen on the admin dashboard - send the admin back
    // instead of silently uploading an unlabeled question.
    window.location.href = "admin.html";
} else {
    const subjectLabel = document.getElementById("subjectLabel");
    if (subjectLabel) subjectLabel.textContent = selectedSubject;
}
